from resourses.lxml import XPath, ElementBase
from resourses.lxml.html import fromstring, XHTML_NAMESPACE
from resourses.lxml.html import _forms_xpath, _options_xpath, _nons, _transform_result
from resourses.lxml.html import defs
import copy
